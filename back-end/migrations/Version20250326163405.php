 ...
 */
final class Version20250326163405 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE enregistrer (utilisateur_id INT NOT NULL, client_id INT NOT NULL, INDEX IDX_945483819EB6921 (client_id), INDEX IDX_9454838FB88E14F (utilisateur_id), PRIMARY KEY(utilisateur_id, client_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
